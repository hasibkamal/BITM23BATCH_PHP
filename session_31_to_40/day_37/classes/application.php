           ...
           $message="
              <h3> Wellcome $data[first_name] $data[last_name]. </h3>
               <p> Thanks for join our community.</p>
                ...
                <a href='http://localhost/seip_ecoomerce23_and_24/customer_update_status.php?id=$en_customer_id'>http://localhost/seip_ecoomerce23_and_24/customer_update_status/id=$en_customer_id</a>
               ";
