            ...
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="center"><?php echo $product_info['publication_status']; ?></td>
                        <td class="center">
                            
                            <a class="btn btn-success" href="view_product.php?product_id=<?php echo $product_info['product_id']; ?>" title="View Product">
                                <i class="halflings-icon white arrow-down"></i>  
                            </a>
                            <a class="btn btn-success" href="" title="Unpublished">
                                <i class="halflings-icon white arrow-down"></i>
                            <a class="btn btn-info" href="edit_manufacturer.php?id=" title="Edit">
                                <i class="halflings-icon white edit"></i>  
                            </a>
                            <a class="btn btn-danger" href="?status=delete&&id=" title="Delete" onclick="return check_delete_info(); ">
